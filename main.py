...
def get_pdf_name() :
    ...
    try :
        ...
        name_url = "https://lib-yau.wqxuetang.com/v1/read/initread?" + url[index + 4 :]
        headers = {
        ...
        dict = res.json()
        return dict['data']['name'],dict['data']['author']
    except :
        return "default"
...
def get_img_from_url(url):
    _url = "https://lib-yau.wqxuetang.com" + url
    headers = {
        'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
        'Accept-Encoding': 'gzip, deflate, br',
        'Accept-Language': 'zh-CN,zh;q=0.9,en-GB;q=0.8,en;q=0.7,en-US;q=0.6',
...
if __name__ == "__main__" :
    ...
    try :
        ...
        print("下载书签完毕")
        # 所有图片下载完毕，准备合成PDF
        pdf_name = get_pdf_name()[0].replace("/", "_")
        pdf_author = get_pdf_name()[1].replace("/", "_")
        print("获取书名完毕，书名为", "《" + pdf_name + "》"+"——作者：" + pdf_author)
        img_path = _image_path
        pdf_path = _pdf_path + "\\" + pdf_name + "——作者：" + pdf_author+ ".pdf"
